...
public class ProducerKeyFileStore {
	...
	public static Map<Long, ProducerIdentity> load(File file) {
	...
	public static void store(File file, Map<Long, ProducerIdentity> producerInfos) {
